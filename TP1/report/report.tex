...
\begin{description}
	\item [\textrr{Name}] [{]\textbf{xs:string}[}]
		Movie name.
	\item [\textrr{Poster}] [{]\textbf{xs:anyURI}[}]
		Movie Poster.
	\item [\textrr{Score}] [{]\textbf{xs:double}[}]
		Movie score according to IMDb votes.
	\item [\textrr{Duration}] [{]\textbf{xs:string}[}]
		Movie duration in minutes.
	\item [\textrr{Genres}] [{]\textbf{xs:sequence}[}]
		An array of Genres. Each one is a string.
	\item [\textrr{Main actors (stars)}] [{]\textbf{xs:sequence}[}]
		An array of Stars. Each one is a string.
	\item [\textrr{Director}] [{]\textbf{xs:string}[}]
		Movie director.
	\item [\textrr{Launch date}] [{]\textbf{xs:string}[}]
		Movie launch date in United States.
	\item [\textrr{Description}] [{]\textbf{xs:string}[}]
